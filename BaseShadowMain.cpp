...
int main() {
	...
	Shader simpleDepthShader("./Shaders/Shadow/shadowMap.vs", "./Shaders/Shadow/shadowMap.fs");
	//Shader debugDepthQuad();
	unsigned int woodTexture = loadTexture("./Textures/deepText/floor.png");
	...
	glVertexAttribPointer(0, 3, GL_FLOAT, GL_FLAT, 8 * sizeof(float), (void*)0);
	glEnableVertexAttribArray(1);
	glVertexAttribPointer(1, 3, GL_FLOAT, GL_FLAT, 8 * sizeof(float), (void*)(sizeof(float) * 3));
	glEnableVertexAttribArray(2);
	glVertexAttribPointer(2, 2, GL_FLOAT, GL_FLAT, 8 * sizeof(float), (void*)(sizeof(float) * 6));
	glBindVertexArray(0);
	...
	while (!glfwWindowShouldClose(window)) {
		...
		ImGui::SliderFloat("LightPos", &lightPos.x, -1.0, 1.0);
		ImGui::End();
		ImGui::Render();
